...
tests = [{'description': 'PINA: 0x40, PINB: 0x40, PINC: 0x40  => PORTD: 0x31',
    ...
    {'description': 'PINA: 0x40, PINB: 0x41, PINC: 0x42  => PORTD: 0xC3',
    'steps': [ {'inputs': [('PINA',0x40), ('PINB', 0x41), ('PINC', 0x42)], 'iterations': 5 } ],
    'expected': [('PORTD',0xC3)],
    },
    {'description': 'PINA: 0x08, PINB: 0x18, PINC: 0x1A  => PORTD: 0x3A',
    'steps': [ {'inputs': [('PINA',0x08), ('PINB', 0x18), ('PINC', 0x1A)], 'iterations': 5 } ],
    'expected': [('PORTD',0x3A)],
    },
